...
public class RunCoreDistanceConfiguration
{
...
//			System.err.println("-------------------------------------------- Trial: " + trial + " ---------------------------------------------------");
			...
			{
				//System.out.println("idLabeled: "+ idLabeled +" minPts: " + minPts + " pmc: " + pmc  + " labeled: " + plab + " trial: " + trial +": " + Arrays.toString(stringLabeled));

				Util.resetDataset(datasetExperiments, false);
				HDBSCANVariations.BCubedBased(clustersStore.get(minPts), mstCd.get(minPts), matrixStore.get(minPts), preLabeledDenBased, datasetExperiments, minPts, report, parameters.hdbscanStarBCubedCd, pmc, plab);

				Util.resetDataset(datasetExperiments, false);
				HDBSCANVariations.HdbscanUnsupervisedAndConstraints(clustersStore.get(minPts), matrixStore.get(minPts), preLabeledDenBased, datasetExperiments, minPts, report, parameters.hdbscanConstraintsCd, pmc, plab);

				Util.resetDataset(datasetExperiments, false);					
				HDBSCANVariations.MixedBCubed(clustersStore.get(minPts), mstCd.get(minPts), matrixStore.get(minPts), preLabeledDenBased, datasetExperiments, minPts, report, parameters.hdbscanStarMixedCd, pmc, plab);

				Util.resetDataset(datasetExperiments, false);					
				HDBSCANVariations.MixedForConstraints(clustersStore.get(minPts), matrixStore.get(minPts), preLabeledDenBased, datasetExperiments, minPts, report, parameters.hdbscanStarMixedForConstraintsCd, pmc, plab);

				Util.resetDataset(datasetUnsupervised, true);
				HDBSCANVariations.HdbscanUnsupervisedAndConstraints(clustersStore.get(minPts), matrixStore.get(minPts), null, datasetUnsupervised, minPts, report, parameters.hdbscanStarCd, pmc, plab);
			}
